...
class EstadoLargura:
    ...
    def __init__(self, pai: Optional["EstadoLargura"] = None, baldes: ProblemaBaldes = None,
    ...
    def gerar_filhos(self) -> list["EstadoLargura"]:
        ...
        for nome_regra in ordem:
            ...
            try:
                ...
                # Regra não aplicável nesse estado (encher balde já cheio).
                continue

            filhos.append(EstadoLargura(
                pai=self,
